...
<head>
    ...
    <link rel="stylesheet" href="/style/css/bookingCancel.css">
    <link rel="stylesheet" href="/style/css/navSub.css">
    <script src="/style/js/navbarSub.js" defer></script>
    <script src="/style/js/bookingCancel.js" defer></script>
	        ...
	        <div class="con_left_right">
	            <div class="con_left">
	                        ...
	                        <div class="calendar calendar1 chk_i">
	                            <div class="calendar_input">
	                                <div class="left_box" id="datePicker">
	                                    ...
	                                    <input type="text" class="selected-date" readonly id="startDate" name="checkIn" value="${bookingInfo.checkIn}">
	                                </div>
	                        ...
	                        <div class="calendar calendar1 chk_i">
	                            <div class="calendar_input">
	                                <div class="left_box" id="datePicker">
	                                    ...
	                                    <input type="text" class="selected-date" readonly id="endDate" name="checkOut" value="${bookingInfo.checkOut}">
	                                </div>
	                                <i class="fa-regular fa-calendar"></i>
	                            </div>
	                ...
	                <div class="people_num">
	                    ...
	                    <div class="num_box">
	                        ...
	                        <p class="result" id="usePeople">${bookingInfo.stayPeople}</p>
	                        <input type="hidden" id="usePeopleValue" name="stayPeople" value="${bookingInfo.stayPeople}">
	                ...
	                <div class="payment" style="display: ruby">
	                    ...
	                    <select id="paymentMethod" disabled>
							<c:choose>
								<c:when test="${paymentInfo.paytypeCode == 'pmt01'}">
	                    ...
	                    <c:if test="${paymentInfo.paytypeCode == 'pmt01'}">
		                    <select id="cardsa" disabled="disabled">
						    	<c:forEach var="card" items="${card}">
						    		<option value="${card.codeKey}">${card.codeName}</option>
						    	</c:forEach>
						    </select>
						    <input type="text" id="cardInfo" value="${paymentInfo.cardNo}" placeholder="카드번호 입력('-'를 포함하여 입력해주세요.)" pattern="\d{4}-\d{4}-\d{4}-\d{4}" required disabled="disabled">
					    </c:if>
					    ...
					    <c:if test="${paymentInfo.paytypeCode == 'pmt02'}">
							...
							<input type="text" value="${paymentInfo.refundAccount}" id="bankInfo" name="refundAccount" placeholder="환불 계좌 입력('-'를 포함하여 입력해주세요.)" style="display: block;" pattern="^(\d{1,})(-(\d{1,})){1,}">
						</c:if>                    
					</div><!-- //payment -->
	                ...
	                <div class="essential">
	                    <h3>환불 사유</h3>
	                    <div class="input_box" >
	                    	<div class="select_btn" style="display: flex;flex-direction: column;align-items: flex-start;">
		                    	<c:forEach var="c" items="${cancelInfo}" varStatus="status">
		                    		<button type="button" id="cancelReason${status.index}" value="${c.codeKey}"><i class="fa-solid fa-check"></i>
		                                        <p>${c.codeName}</p>
	                                </button>
		                        </c:forEach>
		                        <input type="hidden" name="cancelreaCode" id ="cancelreaCode">
							</div>
							
	                        <div class="i_txt_box">
	                            <textarea name="cancelreaContent" id="cancelContent" placeholder="구체적인 사유를 입력해주세요"></textarea>
	                        </div><!-- //i_txt_box -->
	                    </div><!-- //input_box -->
	                </div><!-- //essential -->
	            ...
	            <div class="con_right"> <!-- 오른쪽 예약창 -->
	                <div class="reservation_box">
	                    <div class="r_box_top">
	                        <div class="d_img">
	                        	<img src="${bookingInfo.mainImage}" alt="...">
	                        </div><!-- //d_img -->
	                        <div class="d_txt">
	                            ...
	                            <div class="star_p">
	                                ...
	                                <p>${reviewCntAvg.avg} &#40;후기 ${reviewCntAvg.cnt}개&#41;</p>
	                            </div><!-- //star_p -->
	                        </div><!-- //d_txt -->
	                    </div><!-- //r_box_top -->
	                    <div class="r_box_middle">
	                        <div class="cata">
	                            ...
	                            <div class="c_price">
	                                ...
	                                <span id="detailPrice">결제금액 : ${bookingInfo.totalPrice}</span>
	                                <br>
	                                <span>환불금액 : ${bookingInfo.totalPrice}</span>
	                                <br>	
	                                <span>수수료 : 0</span>
	                    ...
	                    <div class="chk_ok">
	                        ...
	                        <label></label>본인은 AOOM의 환불 약관을 충분히 읽고 이해하였으며, 이에 동의합니다. 
	                    </div><!-- //chk_ok -->
	                    <button id="bookingBtn">예약취소하기</button>
	                </div><!-- //reservation_box -->
	            </div><!-- //con_right -->
	        </div><!-- //con_left_right -->
