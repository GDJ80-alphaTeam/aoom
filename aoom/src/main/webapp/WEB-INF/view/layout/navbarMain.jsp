	     ...
	     <div class="filter">
	         ...
	         <ul class="filter_contents">
	             <li>
	                 ...
	                 <div class="price_box">
	                     <input type="number" min="30000" name="lowPrice" placeholder="최소 가격" value="30000">
	                     <input type="number" min="30000" name="highPrice" placeholder="최대 가격" value="30000">
	                 </div>
	             </li>
	             <li>
	                 <h2>숙소 유형</h2>
	                 ...
	                 <div class="click_box">
	                 	 <input type="hidden" name="roomtypeCode" value="all">
	         ...
	         <div class="filter_b">
	             ...
	             <button type="button" id="filterBtn">필터적용</button>
	         </div>
...
<div class="fixed">
			...
			<!-- 검색 -->
           	<form action="${pageContext.request.contextPath}/room/roomList" method="get">
            	<ul class="search">
	                ...
	                <li class="s_btn">
	                    <button type="submit"><img src="${pageContext.request.contextPath}/img/nav_2.png" alt="검색 아이콘"></button>
	                </li>
            	</ul>
            </form>
    ...
    <div class="category">
        <ul class="inner">
            <li>
            	<a href="${pageContext.request.contextPath}/room/roomList?category=rct01">
            ...
            <li>
            	<a href="${pageContext.request.contextPath}/room/roomList?category=rct02">
            ...
            <li>
            	<a href="${pageContext.request.contextPath}/room/roomList?category=rct03">
            ...
            <li>
            	<a href="${pageContext.request.contextPath}/room/roomList?category=rct04">
            ...
            <li>
            	<a href="${pageContext.request.contextPath}/room/roomList?category=rct05">
            ...
            <li>
            	<a href="${pageContext.request.contextPath}/room/roomList?category=rct06">
            ...
            <li>
            	<a href="${pageContext.request.contextPath}/room/roomList?category=rct07">
            ...
            <li>
            	<a href="${pageContext.request.contextPath}/room/roomList?category=rct08">
            ...
            <li>
            	<a href="${pageContext.request.contextPath}/room/roomList?category=rct09">
            ...
            <li>
            	<a href="${pageContext.request.contextPath}/room/roomList?category=rct10">
            ...
            <li>
            	<a href="${pageContext.request.contextPath}/room/roomList?category=rct11">
            ...
            <li>
            	<a href="${pageContext.request.contextPath}/room/roomList?category=rct12">
